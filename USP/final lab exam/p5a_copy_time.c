...
int main(int argc, char *argv[]) {
    ...
    struct utimbuf tt;  // Structure to update file times
    ...
    tt.modtime = fstat2.st_mtime;  // Set modification time from destination file
    tt.actime = fstat2.st_atime;   // Set access time from destination file
    utime(argv[1], &tt);              // Apply updated timestamps to source file
